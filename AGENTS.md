...
The repository contains M0, M1 upload validation, M2 document extraction, M3 AI PRD analysis, M4 requirement review and selection, and M5 FE/BE test-case generation. See docs/engineering/M1_UPLOAD.md, docs/engineering/M2_EXTRACTION.md, docs/engineering/M3_AI_PRD_ANALYZER.md, docs/engineering/M4_REQUIREMENT_REVIEW.md, and docs/engineering/M5_TEST_CASE_GENERATOR.md for implemented behavior and limitations. Full preview/edit/delete and later product features must be introduced only by their approved milestone, within MVP scope.
