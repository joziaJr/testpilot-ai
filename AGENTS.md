...
The repository contains M0 through M5: foundation, upload validation, extraction, AI PRD analysis, requirement review/selection, and AI test-case generation. See docs/engineering/M1_UPLOAD.md through docs/engineering/M5_TEST_CASE_GENERATION.md for implemented behavior and limitations. Full preview/edit/delete, export, and later product features must be introduced only by their approved milestone, within MVP scope.
