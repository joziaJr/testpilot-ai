...
```text
Browser: upload / review / selection / M6 preview / M7 edit + delete / M8 export-column selection / future TSV
...
| Export-column configuration  | Store one shared allowlisted FE/BE selection using OQ-07 defaults and fixed schema order                                                                                                    | No reorder controls, arbitrary keys, case mutation, serializer, Blob, download, or AI request                                                              |
