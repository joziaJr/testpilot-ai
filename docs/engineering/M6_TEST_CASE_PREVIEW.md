...
- M6 remains the historical read-only preview boundary. M7 layers manual edit/delete onto its accepted result, and M8 adds independent fixed-order column selection. TSV export remains M9.
