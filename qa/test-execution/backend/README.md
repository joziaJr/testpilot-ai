# Backend test execution records

Store actual backend execution attempts here, separately from [case specifications](../../test-cases/backend/README.md). No execution has been performed; this file contains instructions only.
